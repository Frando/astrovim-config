...
local config = {
    ...
    mappings = {
        ...
        n = {
            ...
            -- show buffers
            ["<leader>i"] = { function() telescope.buffers({
                    sort_mru = true,
            ...
            -- find in open file
            ["<leader>o"] = { telescope.current_buffer_fuzzy_find, desc = "Search in current buffer", },
            -- find references
            ["<leader>r"] = { function() telescope.lsp_references() end, desc = "Search references" },

            -- alias Ctrl-P to telescope files
            ["<C-p>"] = { telescope.find_files },

            -- open nerdtree force-focused on current file
            ["<leader>E"] = { "<cmd>Neotree focus reveal reveal_force_cwd<cr>", desc = "Toggle Explorer & cwd" },
    ...
    plugins = {
        ...
        telescope = function(config)
            ...
            -- }
            -- config.defaults.mappings.i = { ["<esc>"] =
            return config
        end,
